...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-start bg-gradient-to-b from-[#1a1625] to-[#0f0c18] text-foreground">
      ...
      {/* Navbar */}
      <nav className="fixed top-0 left-0 w-full h-16 bg-black/70 backdrop-blur-md border-b border-zinc-800 z-50 flex items-center justify-between px-8">
        <h1 className="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-200">
          Dobby
        </h1>
        ...
        <div className="flex-1 max-w-xl mx-8">
          <div className="relative">
            <input
              ...
              className="w-full rounded-md bg-zinc-900 text-sm text-gray-200 pl-10 pr-4 py-2 border border-zinc-700 focus:outline-none focus:ring-2 focus:ring-purple-500"
            />
            <svg
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="w-9 h-9 flex items-center justify-center rounded-full bg-zinc-800 hover:bg-purple-600/30 border border-zinc-700 hover:border-purple-500 transition">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
      ...
      {/* Hero Image */}
      <section className="relative w-full h-[80vh] flex items-center justify-center text-center text-white mt-16">
        <Image
          src={heroImage}
          alt="Cinema"
          fill
