...
CREATE OR REPLACE FUNCTION "public"."create_new_conversation"("recipient_id" "uuid") RETURNS "uuid"
...
ALTER FUNCTION "public"."create_new_conversation"("recipient_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."is_conversation_participant"("c_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN EXISTS (
...
ALTER FUNCTION "public"."is_conversation_participant"("c_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."genre_layers" (
...
ALTER TABLE "public"."genre_layers" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."notifications" (
    ...
    "is_read" boolean DEFAULT false,
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "notifications_type_check" CHECK (("type" = ANY (ARRAY['follow'::"text", 'message'::"text", 'like'::"text", 'reply'::"text"])))
);
...
ALTER TABLE ONLY "public"."genre_layers"
    ADD CONSTRAINT "genre_layers_name_key" UNIQUE ("name");



ALTER TABLE ONLY "public"."genre_layers"
    ADD CONSTRAINT "genre_layers_pkey" PRIMARY KEY ("id");
...
CREATE OR REPLACE TRIGGER "trigger_update_conversations_updated_at" BEFORE UPDATE ON "public"."conversations" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."movie_recommendations"
    ADD CONSTRAINT "movie_recommendations_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."show_recommendations"
    ADD CONSTRAINT "show_recommendations_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."user_embeddings"
    ADD CONSTRAINT "user_embeddings_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
CREATE POLICY "Users can manage their own movie ratings" ON "public"."movie_ratings" USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));



CREATE POLICY "Users can manage their own show ratings" ON "public"."show_ratings" USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));



CREATE POLICY "Users can send messages to their conversations" ON "public"."messages" FOR INSERT WITH CHECK ((("auth"."uid"() = "sender_id") AND "public"."is_conversation_participant"("conversation_id")));
...
CREATE POLICY "Users can view their own conversations" ON "public"."conversations" FOR SELECT USING ("public"."is_conversation_participant"("id"));
...
GRANT ALL ON FUNCTION "public"."create_new_conversation"("recipient_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."create_new_conversation"("recipient_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_new_conversation"("recipient_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_conversation_participant"("c_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_conversation_participant"("c_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_conversation_participant"("c_id" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."genre_layers" TO "anon";
GRANT ALL ON TABLE "public"."genre_layers" TO "authenticated";
GRANT ALL ON TABLE "public"."genre_layers" TO "service_role";
